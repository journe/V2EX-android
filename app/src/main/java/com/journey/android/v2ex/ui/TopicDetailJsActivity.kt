...
class TopicDetailJsActivity : BaseActivity() {
    ...
    object : GetTopicDetailTask() {
      ...
      override fun onFinish(topicDetailBean: TopicDetailBean) {
        ...
        ImageLoader.displayImage(
            view, topicDetailBean.memberBean.avatar,
  ...
  private fun setTopicHeadView(
    topicCommentItemAdapter: CommonAdapter<TopicCommentBean>,
    headView: View
  ) {
  ...
  private fun getTopicCommentItemAdapter(topicComments: ArrayList<TopicCommentBean>): CommonAdapter<TopicCommentBean> {
    return object : CommonAdapter<TopicCommentBean>(
      ...
      override fun convert(
        ...
        ImageLoader.displayImage(
            holder.convertView, t.member.avatar,
